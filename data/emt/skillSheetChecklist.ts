...
export const NREMT_SKILL_SHEET: SkillSheetItem[] = [
  ...
  { id: 'impression', label: 'General Impression', actionIds: ['general_impression', 'rapid_assessment', 'focused_assessment'] },
  { id: 'avpu', label: 'Responsiveness / AVPU', actionIds: ['assess_loc', 'disability', 'rapid_assessment', 'focused_assessment'] },
  { id: 'chief', label: 'Chief Complaint / Life Threats', actionIds: ['chief_complaint', 'rapid_assessment', 'focused_assessment'] },
  { id: 'airway', label: 'Airway', actionIds: ['airway', 'rapid_assessment', 'focused_assessment'] },
  { id: 'breathing', label: 'Breathing', actionIds: ['breathing', 'rapid_assessment', 'focused_assessment'] },
  { id: 'circulation', label: 'Circulation', actionIds: ['circulation', 'rapid_assessment', 'focused_assessment'] },
